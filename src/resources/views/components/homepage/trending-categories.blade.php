...
<div class="bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800/60" id="industry-sectors">
    <div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 max-w-5xl mx-auto">
            @php
                $sectors = [
                    ['name' => 'Construction', 'icon' => 'heroicon-o-building-office-2', 'color' => 'sky', 'count' => 24, 'desc' => 'Building materials, equipment & contractors'],
                    ['name' => 'IT & Technology', 'icon' => 'heroicon-o-cpu-chip', 'color' => 'emerald', 'count' => 18, 'desc' => 'Software, hardware & IT services'],
                    ['name' => 'Real Estate', 'icon' => 'heroicon-o-home-modern', 'color' => 'amber', 'count' => 15, 'desc' => 'Commercial & residential properties'],
                    ['name' => 'Healthcare', 'icon' => 'heroicon-o-heart', 'color' => 'rose', 'count' => 22, 'desc' => 'Medical supplies & healthcare services'],
                    ['name' => 'Logistics', 'icon' => 'heroicon-o-truck', 'color' => 'violet', 'count' => 12, 'desc' => 'Freight, shipping & warehousing'],
                    ['name' => 'Agriculture', 'icon' => 'heroicon-o-sun', 'color' => 'teal', 'count' => 16, 'desc' => 'Farm supplies, produce & agri-tech'],
                    ['name' => 'Food & Beverage', 'icon' => 'heroicon-o-cake', 'color' => 'orange', 'count' => 20, 'desc' => 'Wholesale food, beverages & catering'],
                    ['name' => 'Chemicals', 'icon' => 'heroicon-o-beaker', 'color' => 'cyan', 'count' => 8, 'desc' => 'Industrial chemicals & lab supplies'],
                ];
            @endphp
            @foreach ($sectors as $sector)
                <a href="{{ route('sector.browse') }}" class="group relative flex flex-col gap-3 p-5 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-800/30 hover:shadow-lg hover:border-{{ $sector['color'] }}-200 dark:hover:border-{{ $sector['color'] }}-800 transition-all duration-300 overflow-hidden">
                    {{-- Left accent border --}}
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="min-w-0">
                            ...
                            <span class="text-[11px] text-slate-400 dark:text-slate-500 font-medium">{{ $sector['count'] }} sellers</span>
                        </div>
                    </div>
                    <p class="text-xs text-slate-500 dark:text-slate-400 leading-relaxed">{{ $sector['desc'] }}</p>
                </a>
            @endforeach
        </div>
