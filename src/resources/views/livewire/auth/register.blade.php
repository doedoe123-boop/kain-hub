<div>
    <h2 class="text-2xl font-bold text-center text-slate-800 dark:text-white mb-1">Create your account</h2>
    <p class="text-center text-sm text-slate-500 dark:text-slate-400 mb-6">Join the NegosyoHub marketplace</p>
    ...
    <p class="mt-6 text-center text-sm text-slate-500 dark:text-slate-400">
        ...
        <a href="{{ route('login') }}" class="text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300 font-semibold transition-colors duration-200">Sign in</a>
    </p>

    <p class="mt-3 text-center text-sm text-slate-500 dark:text-slate-400">
        Want to open a store?
        <a href="{{ route('register.sector') }}" class="text-sky-600 dark:text-sky-400 hover:text-sky-700 dark:hover:text-sky-300 font-semibold transition-colors duration-200">Register as a Store Owner</a>
    </p>
</div>
