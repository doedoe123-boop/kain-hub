<x-layouts.app :title="$store->name.' — KainHub Supplier'">
    ...
    <div class="flex flex-col lg:flex-row gap-8">
        ...
        <div class="flex-1 min-w-0 space-y-6">
                ...
                <div class="flex items-start gap-5">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex flex-wrap items-center gap-2">
                            <h1 class="text-xl sm:text-2xl font-bold text-slate-900">{{ $store->name }}</h1>
                        ...
                        @if ($store->description)
                            <p class="mt-2 text-sm text-slate-600 leading-relaxed">{{ $store->description }}</p>
                        @endif
            ...
            {{-- About Section --}}
            <div class="bg-white rounded-lg border border-slate-200 p-6 sm:p-8">
                <h2 class="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-4">About This Supplier</h2>
                @if ($store->description)
                    <div class="prose prose-sm prose-slate max-w-none">
                        <p>{{ $store->description }}</p>
                    </div>
                @else
                    <p class="text-sm text-slate-400 italic">This supplier has not provided a detailed description yet.</p>
                @endif
            </div>
            ...
            <div class="bg-white rounded-lg border border-dashed border-slate-300 p-8 sm:p-10 text-center">
                ...
                <p class="mt-1 text-xs text-slate-400">This supplier's products and services will be listed here.</p>
            </div>
        </div>
        ...
        <aside class="w-full lg:w-72 shrink-0 space-y-5">
            ...
            {{-- Contact / Inquiry CTA --}}
            <div class="bg-sky-50 rounded-lg border border-sky-200 p-5 text-center">
                <h3 class="text-sm font-semibold text-sky-800">Interested in this supplier?</h3>
                <p class="mt-1 text-xs text-sky-600">Contact them to discuss bulk orders, pricing, or partnership opportunities.</p>
